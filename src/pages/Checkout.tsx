  ...
  if (!product) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-[#f8fafc]">
        <h2 className="text-2xl font-bold text-slate-800 mb-4" style={{ fontFamily: "'DM Serif Display', Georgia, serif", fontWeight: 400 }}>
          Your Cart is Empty
        </h2>
        <button
          onClick={() => navigate("/")}
  ...
  return (
    <>
      <style>{`
        ...
        .checkout-display { font-family: 'DM Serif Display', Georgia, serif; font-weight: 400; }
      `}</style>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 ">
          ...
          <div className="mt-12">
            <div className="text-center">
              <h1 className="text-3xl font-bold text-slate-900 mb-2 checkout-display">Checkout</h1>
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            <div className="flex flex-col lg:flex-row gap-8">
              ...
              <div className="flex-grow space-y-6 lg:w-2/3">
                ...
                <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
                  <h2 className="flex items-center gap-2 text-lg font-semibold text-slate-800 mb-6">
                    <User className="w-5 h-5 text-slate-500" /> Personal
                    Information
                  </h2>
              ...
              <div className="lg:w-1/3 space-y-6">
                ...
                <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
                  <h2 className="flex items-center gap-2 text-lg font-semibold text-slate-800 mb-6">
                    <ShoppingCart className="w-5 h-5 text-slate-500" /> Order
                    Summary
                  </h2>
                  ...
                  <div className="flex gap-4 mb-6 pb-6 border-b border-slate-100">
                    ...
                    <div>
                      ...
                      <span className="text-[10px] border border-slate-200 text-slate-500 px-2 py-1 rounded-full">
                        {product.brand}
                      </span>
                    </div>
                  </div>
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <span className="font-bold text-xl text-slate-900 checkout-display">
                ...
                <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
                  ...
                  <ul className="space-y-3">
                    ...
                    <li className="flex items-center gap-3 text-sm text-slate-600">
                      <ShieldCheck className="w-4 h-4 text-blue-500" /> Free
                      professional installation
                    </li>
                    <li className="flex items-center gap-3 text-sm text-slate-600">
                      <CheckCircle className="w-4 h-4 text-purple-500" />{" "}
                      {product.warranty} comprehensive
                    </li>
                  </ul>
                </div>
              </div>
